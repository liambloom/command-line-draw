...
class Menu extends Sprite {
  constructor (callback, options, style) {
    ...
    super((x, y, color) => {
      ...
      else if (this.terminal.clearMode) this.#open = false;
    ...
    Object.defineProperties(this, {
      ...
      width: {
        get: function () {
          return this.borderChars.vertical.length + options.map(e => e.length + 4 + this.borderChars.vertical.length).reduce((a, b) => a + b)
        }
      },
      height: {
        value: 3
